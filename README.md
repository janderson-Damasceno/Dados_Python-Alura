...
Filtros Laterais : Permite filtrar os dados por Ano, Antiguidade, Tipo de Contrato e Tamanho da Empresa.
KPIs (Métricas) : Exibe Salário Médio, Salário Máximo, Total de Registros e Carga mais frequentes.
Gráficos :
